...
const KEY_FINDINGS = [
  {
    ...
    finding: "640,000 households are in core housing need today — projected to reach ~940,000 by 2041 at current delivery rates. The gap between social housing need and supply widens every year. HAFF and the Housing Accord together represent the largest federal intervention since the 1950s — but remain structurally insufficient at current delivery rates.",
...
export default function ResearchPage() {
  ...
  const policyBriefOpts = (): BriefOpts => {
    ...
    return {
      ...
      footer: "Generated by HIVE — Housing Intelligence & Evidence. AI-synthesised from 630+ indexed research reports; verify against primary sources before use.",
    }
  }
      ...
      <div className="page-container">
        ...
        <div className="page-header">
          ...
          <p className="page-subtitle">
            630+ indexed reports across AHURI, AIHW, ABS, Housing Australia and 20+ organisations.
        ...
        {activeTab === "Ask Research" && (
          <div>
            <div className="grid-4" style={{ marginBottom: 28 }}>
              {[
                { value: "630+",      label: "Reports indexed",        color: "#f6c90e" },
            ...
            {proState === "unlocked" ? (
              ...
              <ProUpgradePanel
                ...
                body="Ask any question and get cited answers across 630+ reports, 20 years of evidence (2004–2025). On the free plan you can browse the Source Library and Program Scorecard."
              />
            ) : (
        ...
        {activeTab === "Policy Analyser" && proState === "locked" && (
          <ProUpgradePanel
            ...
            body="Analyse any major Australian housing policy against the full 630+ report evidence base with AI synthesis. On the free plan you can browse the Source Library and Program Scorecard."
          />
        )}
          ...
          <div>
            ...
            <div className="hive-card" style={{ marginBottom: 24 }}>
              ...
              <p style={{ fontSize: "0.8rem", color: "#94a3b8", marginBottom: 16, lineHeight: 1.65 }}>
                ...
                Synthesis drawn from 630+ reports across AHURI, AIHW, government evaluations, and academic literature.
              </p>
              <select
                value={selectedIdx}
            ...
            {loading && (
              <div className="hive-card" style={{ textAlign: "center", padding: 40, color: "#94a3b8" }}>
                ...
                <div style={{ fontSize: "0.82rem" }}>Querying 630+ reports for &quot;{policy.event}&quot;</div>
              </div>
            )}
        ...
        {activeTab === "Program Scorecard" && (
          <div>
            ...
            <div className="callout-blue" style={{ marginBottom: 24, fontSize: "0.74rem", color: "#94a3b8" }}>
              <strong style={{ color: "#7aaad4" }}>How the delivery grade works (HIVE rubric).</strong>{" "}
              ...
              Thresholds are HIVE-defined (completed: A ≥95% · B ≥80% · C ≥60% · D ≥40% · F below; active: delivery÷elapsed-time ratio
              A ≥1.05 · B ≥0.9 · C ≥0.7 · D ≥0.5 · F below). Targets and outcomes are sourced from government evaluations — the grade is HIVE&apos;s reading of them.
            </div>
        ...
        {activeTab === "Source Library" && (
          <div>
            <p className="page-subtitle" style={{ marginBottom: 8 }}>
              20 curated anchor reports from the 630+ documents indexed in HIVE — the foundational references
              across AHURI, AIHW, ABS, Housing Australia, ANAO, and industry bodies. All are searchable
              via Ask Research above.
            </p>
            <div className="callout-blue" style={{ marginBottom: 24, fontSize: "0.78rem", color: "#94a3b8" }}>
              <strong style={{ color: "#7aaad4" }}>630+ reports indexed · 20 shown here.</strong>{" "}
              The full corpus is searchable via the Ask Research tab — type any question to query across the full corpus.
