      ...
      <div className="page-container">
        ...
        <div className="page-header">
          ...
          <p className="page-subtitle">
            $49.1B in program capacity across 8 active programs — yet only 47% of the HAFF 40,000-home target is contracted (53% remains), construction costs have risen 58.5% since 2019, and the same $1B now builds ~37% fewer homes. This is the complete funding intelligence layer: what&apos;s available, what it pays, and what it still can&apos;t close.
          </p>
        </div>
