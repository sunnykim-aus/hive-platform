...
export const CLIMATE_RISK_SUBURBS: ClimateRiskSuburb[] = [
...

  {
    ...
    flood: { score: 98, level: "Critical", in_flood_overlay: true, overlay_type: "Wilson River floodplain x 1-in-500yr events now occurring regularly", pct_area_in_overlay: 65, last_major_event: "March 2022 x 14.4m flood peak, 4,000+ homes inundated, highest flood in 154 years of records", notes: "Australia's most catastrophically flood-affected city. The 2022 event exceeded the 1-in-500yr benchmark. Climate science projects Northern Rivers will experience 1-in-100yr floods approximately every 15 years by 2050." },
