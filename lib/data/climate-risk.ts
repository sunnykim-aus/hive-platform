...
// HEAT DATA RE-BASED 2026-07 to BOM per-station climatology + CSIRO-consistent projections.
// days_over_35/40 were previously overstated ~2-20x for metro/coastal/tropical suburbs
// (e.g. Sydney 30->3.2, Cairns 58->3.3, Townsville 65->3.7, Darwin 92->14; arid zones
// e.g. Alice 93, Mount Isa 127, Port Hedland 142 were accurate). Baselines: BOM 'Mean
// number of days >=35/40C' Annual per representative station; projections ~x1.4 (2030),
// ~x1.8 (2050). Confidence: BOM-confirmed for capitals+key outback, established regional
// climatology for smaller regional zones. Heat SCORE (0-100) unchanged (review separately).
export const CLIMATE_RISK_SUBURBS: ClimateRiskSuburb[] = [
...

  {
    ...
    heat: { score: 54, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.8, tree_canopy_cover_pct: 9, tenant_vulnerability: "Critical", cooling_access_rate_pct: 45, notes: "One of western Sydney's hottest suburbs. Very low canopy cover, high proportion of concrete/asphalt. Elderly and disability tenants at extreme heat-health risk. Social housing stock has poor thermal performance." },
    coastal: null,
    cyclone: null,
    overall_score: 42, overall_level: "Moderate", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 47, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 14, tenant_vulnerability: "High", cooling_access_rate_pct: 52, notes: "Inland position amplifies heat. Growing concern about cooling access in social housing." },
    coastal: null,
    cyclone: null,
    overall_score: 48, overall_level: "Moderate", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 32, level: "Low", days_over_35_current: 10, days_over_35_2030: 14, days_over_35_2050: 18, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 28, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 68, notes: "Subtropical, humid x heat is a factor but not the primary risk." },
    coastal: null,
    cyclone: null,
    overall_score: 51, overall_level: "Moderate", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 36, level: "Low", days_over_35_current: 5, days_over_35_2030: 7, days_over_35_2050: 9, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 20, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Moderate heat risk, will intensify with climate change." },
    coastal: null,
    cyclone: null,
    overall_score: 46, overall_level: "Moderate", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 66, level: "High", days_over_35_current: 47, days_over_35_2030: 66, days_over_35_2050: 85, days_over_40_current: 10, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "Australia's most heat-exposed significant town. Averaging 47 days above 35xC currently x projected to reach near-continuous summer heat by 2050. Significant proportion of elderly and Indigenous tenants with very low cooling access in ageing social housing stock." },
    coastal: null,
    cyclone: null,
    overall_score: 33, overall_level: "Low", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 46, level: "Moderate", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 12, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "South-east Melbourne heat island effect, compounded by high cultural diversity and language barriers in heat-health communication." },
    coastal: null,
    cyclone: null,
    overall_score: 43, overall_level: "Moderate", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 35, level: "Low", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 55, notes: "Moderate heat risk, but rapidly increasing under climate projections." },
    coastal: null,
    cyclone: null,
    overall_score: 55, overall_level: "High", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 1, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 62, notes: "Sub-tropical heat. Social housing estates have inadequate cross-ventilation and insulation." },
    coastal: null,
    cyclone: null,
    overall_score: 51, overall_level: "Moderate", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 66, level: "High", days_over_35_current: 4, days_over_35_2030: 5, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 2.5, tree_canopy_cover_pct: 14, tenant_vulnerability: "Critical", cooling_access_rate_pct: 72, notes: "Tropical heat is a year-round challenge. Projected ~7 days above 35xC by 2050 (2xC) — note Cairns heat is humidity/apparent-temp driven, not a high 35C-day count. High Indigenous and low-income population. Old social housing stock with minimal insulation." },
    ...
    overall_score: 58, overall_level: "High", primary_hazard: "Cyclone",
...

  {
    ...
    heat: { score: 62, level: "High", days_over_35_current: 3, days_over_35_2030: 5, days_over_35_2050: 6, days_over_40_current: 0, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 22, tenant_vulnerability: "Critical", cooling_access_rate_pct: 68, notes: "Tropical north x heat and humidity together create extreme conditions. Heat-humidity index (wet bulb) is approaching physiological limits on worst summer days." },
    ...
    overall_score: 61, overall_level: "High", primary_hazard: "Cyclone",
...

  {
    ...
    heat: { score: 95, level: "Critical", days_over_35_current: 127, days_over_35_2030: 159, days_over_35_2050: 184, days_over_40_current: 23, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 5, tenant_vulnerability: "Critical", cooling_access_rate_pct: 42, notes: "One of Australia's hottest towns. 127 days above 35xC currently x approaching year-round heat stress by 2050. Significant First Nations population in poorly insulated housing. Mining industry dust compounds respiratory health risk alongside heat." },
    coastal: null,
    cyclone: null,
    overall_score: 53, overall_level: "High", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 42, level: "Moderate", days_over_35_current: 16, days_over_35_2030: 22, days_over_35_2050: 29, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 65, notes: "Subtropical heat is a significant and growing challenge, compounding the flood displacement risk." },
    coastal: null,
    ...
    overall_score: 50, overall_level: "Moderate", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 59, level: "High", days_over_35_current: 27, days_over_35_2030: 38, days_over_35_2050: 48, days_over_40_current: 4, urban_heat_island_factor: 2.8, tree_canopy_cover_pct: 8, tenant_vulnerability: "Critical", cooling_access_rate_pct: 48, notes: "Perth's most heat-stressed social housing suburb. Very low canopy, high concrete density, predominantly non-English speaking communities with barriers to heat-health information. Significant elderly and disability population in old DCA housing stock." },
    coastal: null,
    cyclone: null,
    overall_score: 34, overall_level: "Low", primary_hazard: "Extreme Heat",
...

  {
    ...
    overall_score: 65, overall_level: "Critical", primary_hazard: "Cyclone",
...

  {
    ...
    heat: { score: 90, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 12, tenant_vulnerability: "Critical", cooling_access_rate_pct: 55, notes: "Year-round tropical heat. Significant First Nations population in housing that was not designed for the climate. Heat-humidity combination is physiologically extreme in wet season." },
    ...
    overall_score: 60, overall_level: "High", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 84, level: "Critical", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 8, tenant_vulnerability: "Critical", cooling_access_rate_pct: 40, notes: "Remote outback heat crisis. Large First Nations population in poorly insulated government housing. The town has already experienced heat mortality events. Economic decline compounds the vulnerability." },
...

  {
    ...
    heat: { score: 29, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 25, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 72, notes: "Tasmania's cooler climate limits heat risk currently, but climate change will bring increasing heat events." },
    coastal: null,
    cyclone: null,
    overall_score: 46, overall_level: "Moderate", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 26, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 1.0, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 75, notes: "Tasmania's cooler climate. Heat risk is currently low but will grow." },
    coastal: null,
    cyclone: null,
    overall_score: 37, overall_level: "Low", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 88, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 35, notes: "One of Australia's hottest and most disadvantaged communities. 93 days above 35xC currently x projected to approach year-round extreme heat by 2050. Town camp housing is some of the worst-quality social housing in Australia, with minimal insulation, poor ventilation, and unreliable power supply." },
    coastal: null,
    cyclone: null,
    overall_score: 63, overall_level: "Critical", primary_hazard: "Extreme Heat",
...

  {
    ...
    heat: { score: 83, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 14, tenant_vulnerability: "Critical", cooling_access_rate_pct: 48, notes: "Tropical Top End heat. The 2023 flood destroyed cooling infrastructure in many homes. Recovery housing was constructed without adequate heat mitigation." },
    coastal: null,
    ...
    overall_score: 70, overall_level: "Critical", primary_hazard: "Flood",
...

  {
    ...
    heat: { score: 61, level: "High", days_over_35_current: 14, days_over_35_2030: 19, days_over_35_2050: 25, days_over_40_current: 0, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 72, notes: "Tropical heat and humidity year-round. Palmerston is Darwin's satellite city x relatively newer housing stock with better cooling access but still significant heat-health risk during power outages." },
    ...
    overall_score: 52, overall_level: "High", primary_hazard: "Cyclone",
...

  {
    ...
    heat: { score: 35, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 62, notes: "Canberra's cold winters can mask the heat risk. Summer heat is significant and intensifying. Social housing has poor insulation relative to newer stock." },
    coastal: null,
    cyclone: null,
    overall_score: 43, overall_level: "Moderate", primary_hazard: "Bushfire",
...

  {
    ...
    heat: { score: 30, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 72, notes: "Newer housing stock with better thermal performance. Heat risk exists but is less acute than older suburbs." },
    coastal: null,
    cyclone: null,
    overall_score: 37, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "nsw-penrith", suburb_name: "Penrith", lga_name: "Penrith City", sa4_name: "Sydney x Outer West", state: "NSW", lat: -33.751, lng: 150.694, postcode: "2750", social_housing_density: "High", est_social_dwellings: 2800, seifa_score: 918, key_chps: ["Link Wentworth", "Uniting"],
    ...
    heat: { score: 49, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.5, tree_canopy_cover_pct: 12, tenant_vulnerability: "High", cooling_access_rate_pct: 50, notes: "Western Sydney heat trap x consistently hottest area in Sydney metro." },
    coastal: null, cyclone: null, overall_score: 55, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-liverpool", suburb_name: "Liverpool", lga_name: "Liverpool City", sa4_name: "Sydney x South West", state: "NSW", lat: -33.920, lng: 150.924, postcode: "2170", social_housing_density: "High", est_social_dwellings: 2600, seifa_score: 882, key_chps: ["SGCH", "MA Housing"],
    ...
    bushfire: { score: 15, level: "Low", in_bushfire_prone_land: false, bal_zone: "N/A", pct_area_bushfire_prone: 5, notes: "Urban area, minimal bushfire exposure." },
    heat: { score: 49, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 10, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Southwestern Sydney heat with large CALD community with language barriers to heat-health warnings." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-wollongong", suburb_name: "Wollongong", lga_name: "Wollongong City", sa4_name: "Illawarra", state: "NSW", lat: -34.424, lng: 150.893, postcode: "2500", social_housing_density: "Medium", est_social_dwellings: 1800, seifa_score: 942, key_chps: ["Anglicare"],
    ...
    heat: { score: 27, level: "Low", days_over_35_current: 2, days_over_35_2030: 2, days_over_35_2050: 3, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 32, tenant_vulnerability: "Low", cooling_access_rate_pct: 68, notes: "Coastal location moderates heat." },
    ...
    cyclone: null, overall_score: 46, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "nsw-albury", suburb_name: "Albury", lga_name: "Albury City", sa4_name: "Riverina", state: "NSW", lat: -36.080, lng: 146.916, postcode: "2640", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 958, key_chps: ["Hume"],
    ...
    heat: { score: 41, level: "Moderate", days_over_35_current: 25, days_over_35_2030: 35, days_over_35_2050: 45, days_over_40_current: 3, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 25, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Inland location with significant heat exposure x worsening under climate projections." },
    coastal: null, cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "nsw-wagga-wagga", suburb_name: "Wagga Wagga", lga_name: "Wagga Wagga City", sa4_name: "Riverina", state: "NSW", lat: -35.118, lng: 147.369, postcode: "2650", social_housing_density: "Medium", est_social_dwellings: 1600, seifa_score: 924, key_chps: ["Hume"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 25, days_over_35_2030: 35, days_over_35_2050: 45, days_over_40_current: 3, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Inland Riverina heat x significant and intensifying." },
    coastal: null, cyclone: null, overall_score: 49, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "vic-frankston", suburb_name: "Frankston", lga_name: "Frankston City", sa4_name: "Melbourne x South East", state: "VIC", lat: -38.140, lng: 145.127, postcode: "3199", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 896, key_chps: ["Housing Choices"],
    ...
    heat: { score: 38, level: "Low", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 55, notes: "Coastal location moderates heat somewhat but summer extremes are increasing." },
    ...
    cyclone: null, overall_score: 39, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-ballarat", suburb_name: "Ballarat", lga_name: "Ballarat City", sa4_name: "Ballarat", state: "VIC", lat: -37.562, lng: 143.849, postcode: "3350", social_housing_density: "Medium", est_social_dwellings: 1800, seifa_score: 924, key_chps: ["Housing Choices"],
    ...
    heat: { score: 30, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 62, notes: "Higher altitude moderates heat but summer extremes are increasing." },
    coastal: null, cyclone: null, overall_score: 40, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "vic-wodonga", suburb_name: "Wodonga", lga_name: "Wodonga City", sa4_name: "Hume", state: "VIC", lat: -36.121, lng: 146.888, postcode: "3690", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 942, key_chps: ["Haven"],
    ...
    heat: { score: 40, level: "Moderate", days_over_35_current: 20, days_over_35_2030: 28, days_over_35_2050: 36, days_over_40_current: 2, urban_heat_island_factor: 1.7, tree_canopy_cover_pct: 24, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Inland location with significant heat increasing under projections." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "qld-bundaberg", suburb_name: "Bundaberg", lga_name: "Bundaberg Region", sa4_name: "Wide Bay", state: "QLD", lat: -24.867, lng: 152.350, postcode: "4670", social_housing_density: "High", est_social_dwellings: 1800, seifa_score: 862, key_chps: ["CHL"],
    ...
    heat: { score: 37, level: "Low", days_over_35_current: 5, days_over_35_2030: 7, days_over_35_2050: 9, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 20, tenant_vulnerability: "High", cooling_access_rate_pct: 60, notes: "Subtropical inland heat with significant social housing stock." },
    ...
    overall_score: 48, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-hervey-bay", suburb_name: "Hervey Bay", lga_name: "Fraser Coast", sa4_name: "Wide Bay", state: "QLD", lat: -25.288, lng: 152.854, postcode: "4655", social_housing_density: "Medium", est_social_dwellings: 1600, seifa_score: 908, key_chps: ["CHL"],
    ...
    heat: { score: 35, level: "Low", days_over_35_current: 5, days_over_35_2030: 7, days_over_35_2050: 9, days_over_40_current: 0, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 25, tenant_vulnerability: "High", cooling_access_rate_pct: 62, notes: "Large retiree population in social housing with high heat vulnerability." },
    ...
    overall_score: 39, overall_level: "Low", primary_hazard: "Coastal",
  ...
  { id: "qld-mackay", suburb_name: "Mackay", lga_name: "Mackay Region", sa4_name: "Mackay x Isaac x Whitsunday", state: "QLD", lat: -21.154, lng: 149.186, postcode: "4740", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 918, key_chps: ["CHL", "Horizon"],
    ...
    heat: { score: 37, level: "Low", days_over_35_current: 2, days_over_35_2030: 3, days_over_35_2050: 4, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 65, notes: "Tropical heat with high humidity. Pre-cyclone code housing stock does not meet current standards." },
    ...
    overall_score: 48, overall_level: "Moderate", primary_hazard: "Cyclone",
  ...
  { id: "qld-toowoomba", suburb_name: "Toowoomba", lga_name: "Toowoomba Region", sa4_name: "Toowoomba", state: "QLD", lat: -27.561, lng: 151.953, postcode: "4350", social_housing_density: "Medium", est_social_dwellings: 1800, seifa_score: 926, key_chps: ["CHL"],
    ...
    heat: { score: 32, level: "Low", days_over_35_current: 2, days_over_35_2030: 3, days_over_35_2050: 4, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 28, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 62, notes: "Higher altitude moderates heat but summer extremes increasing." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "wa-mandurah", suburb_name: "Mandurah", lga_name: "Mandurah City", sa4_name: "Perth x South East", state: "WA", lat: -32.527, lng: 115.722, postcode: "6210", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 908, key_chps: ["Foundation", "Housing Choices"],
    ...
    heat: { score: 50, level: "Moderate", days_over_35_current: 27, days_over_35_2030: 38, days_over_35_2050: 48, days_over_40_current: 4, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 16, tenant_vulnerability: "High", cooling_access_rate_pct: 52, notes: "Perth's outer southern suburb with significant heat and elderly population in social housing." },
    ...
    cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-kalgoorlie", suburb_name: "Kalgoorlie", lga_name: "Kalgoorlie-Boulder City", sa4_name: "WA x Outback (South)", state: "WA", lat: -30.749, lng: 121.466, postcode: "6430", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 848, key_chps: ["Foundation"],
    ...
    heat: { score: 66, level: "High", days_over_35_current: 55, days_over_35_2030: 77, days_over_35_2050: 99, days_over_40_current: 8, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 5, tenant_vulnerability: "High", cooling_access_rate_pct: 45, notes: "Remote WA outback heat. Very high temperatures with significant First Nations population in poor quality housing." },
    coastal: null, cyclone: null, overall_score: 37, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-geraldton", suburb_name: "Geraldton", lga_name: "Greater Geraldton City", sa4_name: "WA x Wheat Belt", state: "WA", lat: -28.775, lng: 114.615, postcode: "6530", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 876, key_chps: ["Foundation"],
    ...
    heat: { score: 63, level: "High", days_over_35_current: 50, days_over_35_2030: 70, days_over_35_2050: 90, days_over_40_current: 7, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 8, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Mid-west WA heat. Significant First Nations population. Social housing quality is a key challenge." },
  ...
  { id: "sa-whyalla", suburb_name: "Whyalla", lga_name: "Whyalla City", sa4_name: "South Australia x Outback", state: "SA", lat: -33.030, lng: 137.583, postcode: "5600", social_housing_density: "High", est_social_dwellings: 2000, seifa_score: 802, key_chps: ["Unity Housing"],
    ...
    heat: { score: 85, level: "Critical", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "Outback SA heat with economic decline from steel industry. SEIFA disadvantage compounds heat vulnerability. Very low canopy and cooling access." },
    ...
    cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-morphett-vale", suburb_name: "Morphett Vale", lga_name: "Onkaparinga City", sa4_name: "Adelaide x South", state: "SA", lat: -35.128, lng: 138.520, postcode: "5162", social_housing_density: "High", est_social_dwellings: 2400, seifa_score: 875, key_chps: ["Unity Housing"],
    ...
    heat: { score: 52, level: "Moderate", days_over_35_current: 22, days_over_35_2030: 30, days_over_35_2050: 39, days_over_40_current: 4, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 12, tenant_vulnerability: "High", cooling_access_rate_pct: 42, notes: "Adelaide's southern suburbs heat risk. Very low cooling access in older social housing stock." },
  ...
  { id: "tas-launceston-ravenswood", suburb_name: "Ravenswood / Launceston", lga_name: "Launceston City", sa4_name: "Launceston and North East", state: "TAS", lat: -41.442, lng: 147.145, postcode: "7250", social_housing_density: "High", est_social_dwellings: 2600, seifa_score: 782, key_chps: ["Housing Choices"],
    ...
    heat: { score: 27, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 26, tenant_vulnerability: "Low", cooling_access_rate_pct: 72, notes: "Tasmania's northern city x cooler climate than mainland but increasing heat events." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "tas-devonport", suburb_name: "Devonport", lga_name: "Devonport City", sa4_name: "West and North West", state: "TAS", lat: -41.177, lng: 146.353, postcode: "7310", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 898, key_chps: ["Housing Choices"],
    ...
    heat: { score: 25, level: "Low", days_over_35_current: 1, days_over_35_2030: 1, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.9, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 78, notes: "North-west Tasmanian climate x mild temperatures currently." },
    ...
    cyclone: null, overall_score: 35, overall_level: "Low", primary_hazard: "Coastal",
  ...
  { id: "nt-darwin-casuarina", suburb_name: "Casuarina / Darwin", lga_name: "Darwin City", sa4_name: "Darwin", state: "NT", territory: true, lat: -12.380, lng: 130.892, postcode: "0810", social_housing_density: "High", est_social_dwellings: 2800, seifa_score: 918, key_chps: ["CHL", "Anglicare"],
    ...
    overall_score: 53, overall_level: "High", primary_hazard: "Cyclone",
  ...
  { id: "nsw-bankstown", suburb_name: "Bankstown", lga_name: "Canterbury-Bankstown", sa4_name: "Sydney — South West", state: "NSW", lat: -33.919, lng: 151.034, postcode: "2200", social_housing_density: "High", est_social_dwellings: 2600, seifa_score: 862, key_chps: ["SGCH", "Uniting"],
    ...
    heat: { score: 50, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.6, tree_canopy_cover_pct: 9, tenant_vulnerability: "High", cooling_access_rate_pct: 45, notes: "Inner-west Sydney heat island. Large CALD community with language barriers to heat-health messaging." },
    coastal: null, cyclone: null, overall_score: 39, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-redfern-waterloo", suburb_name: "Redfern / Waterloo", lga_name: "City of Sydney", sa4_name: "Sydney — Inner City", state: "NSW", lat: -33.896, lng: 151.205, postcode: "2016", social_housing_density: "Very High", est_social_dwellings: 3800, seifa_score: 808, key_chps: ["SGCH", "Bridge"],
    ...
    heat: { score: 50, level: "Moderate", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 6, days_over_40_current: 0, urban_heat_island_factor: 3.0, tree_canopy_cover_pct: 8, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "Australia's densest public housing estate. High-rise towers with poor thermal performance. Significant elderly, disability and Indigenous population. Urban heat island in the heart of Sydney." },
    coastal: null, cyclone: null, overall_score: 29, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-dubbo", suburb_name: "Dubbo", lga_name: "Dubbo Regional", sa4_name: "Central West", state: "NSW", lat: -32.247, lng: 148.601, postcode: "2830", social_housing_density: "High", est_social_dwellings: 1800, seifa_score: 836, key_chps: ["MA Housing"],
    ...
    heat: { score: 52, level: "Moderate", days_over_35_current: 22, days_over_35_2030: 31, days_over_35_2050: 40, days_over_40_current: 2, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 14, tenant_vulnerability: "Critical", cooling_access_rate_pct: 40, notes: "Inland NSW heat crisis. Significant First Nations population in social housing with very limited cooling access. One of NSW's highest heat-vulnerability regional cities." },
    coastal: null, cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-tamworth", suburb_name: "Tamworth", lga_name: "Tamworth Regional", sa4_name: "New England and North West", state: "NSW", lat: -31.083, lng: 150.917, postcode: "2340", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 872, key_chps: ["Hume"],
    ...
    heat: { score: 45, level: "Moderate", days_over_35_current: 19, days_over_35_2030: 27, days_over_35_2050: 34, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Inland regional city with significant heat exposure. Ageing social housing stock with poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-nowra", suburb_name: "Nowra", lga_name: "Shoalhaven City", sa4_name: "Illawarra", state: "NSW", lat: -34.878, lng: 150.601, postcode: "2541", social_housing_density: "High", est_social_dwellings: 1600, seifa_score: 858, key_chps: ["Anglicare"],
    ...
    heat: { score: 31, level: "Low", days_over_35_current: 2, days_over_35_2030: 2, days_over_35_2050: 3, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 28, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Coastal location moderates heat but summer extremes increasing." },
    ...
    cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "nsw-coffs-harbour", suburb_name: "Coffs Harbour", lga_name: "Coffs Harbour City", sa4_name: "Mid North Coast", state: "NSW", lat: -30.296, lng: 153.114, postcode: "2450", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 904, key_chps: ["Home in Place"],
    ...
    heat: { score: 28, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 32, tenant_vulnerability: "Low", cooling_access_rate_pct: 68, notes: "Coastal sub-tropical climate moderates heat currently." },
    ...
    cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "vic-craigieburn", suburb_name: "Craigieburn", lga_name: "Hume City", sa4_name: "Melbourne — North West", state: "VIC", lat: -37.600, lng: 144.941, postcode: "3064", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 952, key_chps: ["Housing Choices"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 12, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Outer northern Melbourne growth corridor. Newer stock has better thermal performance but urban heat island effect is significant." },
    coastal: null, cyclone: null, overall_score: 36, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-shepparton", suburb_name: "Shepparton", lga_name: "Greater Shepparton", sa4_name: "Hume", state: "VIC", lat: -36.383, lng: 145.400, postcode: "3630", social_housing_density: "High", est_social_dwellings: 1600, seifa_score: 842, key_chps: ["Haven", "Housing Choices"],
    ...
    heat: { score: 46, level: "Moderate", days_over_35_current: 20, days_over_35_2030: 28, days_over_35_2050: 36, days_over_40_current: 2, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 52, notes: "Inland Victorian heat. Large refugee and CALD community in social housing. Language barriers compound heat-health risk." },
    coastal: null, cyclone: null, overall_score: 49, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "vic-bendigo", suburb_name: "Bendigo", lga_name: "Greater Bendigo", sa4_name: "Bendigo", state: "VIC", lat: -36.758, lng: 144.282, postcode: "3550", social_housing_density: "Medium", est_social_dwellings: 1800, seifa_score: 928, key_chps: ["Housing Choices", "Haven"],
    ...
    heat: { score: 41, level: "Moderate", days_over_35_current: 20, days_over_35_2030: 28, days_over_35_2050: 36, days_over_40_current: 2, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Regional city with significant heat increasing. Older heritage housing stock has poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "qld-ipswich-central", suburb_name: "Ipswich / Booval", lga_name: "Ipswich City", sa4_name: "Ipswich", state: "QLD", lat: -27.617, lng: 152.760, postcode: "4305", social_housing_density: "High", est_social_dwellings: 2400, seifa_score: 818, key_chps: ["CHL", "Centacare"],
    ...
    heat: { score: 45, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 1, urban_heat_island_factor: 2.2, tree_canopy_cover_pct: 16, tenant_vulnerability: "High", cooling_access_rate_pct: 58, notes: "Inland SEQ heat. Significant social housing concentration in heat-exposed locations." },
    coastal: null, cyclone: null, overall_score: 49, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-redcliffe", suburb_name: "Redcliffe", lga_name: "Moreton Bay Region", sa4_name: "Brisbane — North", state: "QLD", lat: -27.228, lng: 153.106, postcode: "4020", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 912, key_chps: ["CHL", "Horizon"],
    ...
    heat: { score: 35, level: "Low", days_over_35_current: 4, days_over_35_2030: 6, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 24, tenant_vulnerability: "High", cooling_access_rate_pct: 62, notes: "Large retiree population in social housing with high heat vulnerability." },
    ...
    overall_score: 37, overall_level: "Low", primary_hazard: "Coastal",
  ...
  { id: "qld-sunshine-coast-caloundra", suburb_name: "Caloundra / Sunshine Coast", lga_name: "Sunshine Coast Region", sa4_name: "Sunshine Coast", state: "QLD", lat: -26.802, lng: 153.135, postcode: "4551", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 962, key_chps: ["CHL"],
    ...
    heat: { score: 33, level: "Low", days_over_35_current: 2, days_over_35_2030: 3, days_over_35_2050: 4, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 30, tenant_vulnerability: "High", cooling_access_rate_pct: 65, notes: "Coastal climate moderates heat. Large retiree population with heat vulnerability." },
    ...
    overall_score: 41, overall_level: "Low", primary_hazard: "Coastal",
  ...
  { id: "qld-gladstone", suburb_name: "Gladstone", lga_name: "Gladstone Region", sa4_name: "Central Queensland", state: "QLD", lat: -23.844, lng: 151.255, postcode: "4680", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 916, key_chps: ["CHL"],
    ...
    heat: { score: 41, level: "Moderate", days_over_35_current: 16, days_over_35_2030: 22, days_over_35_2050: 29, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 16, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Central Queensland industrial heat. Port and industrial activity adds to ambient temperature." },
    ...
    overall_score: 40, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-balga", suburb_name: "Balga / Girrawheen", lga_name: "Stirling City", sa4_name: "Perth — North West", state: "WA", lat: -31.823, lng: 115.836, postcode: "6061", social_housing_density: "Very High", est_social_dwellings: 3400, seifa_score: 758, key_chps: ["Foundation", "Housing Choices"],
    ...
    heat: { score: 61, level: "High", days_over_35_current: 27, days_over_35_2030: 38, days_over_35_2050: 48, days_over_40_current: 4, urban_heat_island_factor: 3.0, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 42, notes: "Perth's most concentrated social housing suburb and extreme heat island. SEIFA 1 — most disadvantaged in WA. Very low canopy, high proportion of ageing DCA housing with no cooling." },
    coastal: null, cyclone: null, overall_score: 35, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-rockingham", suburb_name: "Rockingham", lga_name: "Rockingham City", sa4_name: "Perth — South East", state: "WA", lat: -32.281, lng: 115.729, postcode: "6168", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 882, key_chps: ["Foundation", "Housing Choices"],
    ...
    heat: { score: 51, level: "Moderate", days_over_35_current: 27, days_over_35_2030: 38, days_over_35_2050: 48, days_over_40_current: 4, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 14, tenant_vulnerability: "High", cooling_access_rate_pct: 52, notes: "Southern Perth suburb with significant heat and large social housing estate." },
    ...
    cyclone: null, overall_score: 46, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-carnarvon", suburb_name: "Carnarvon", lga_name: "Carnarvon Shire", sa4_name: "WA — Wheat Belt", state: "WA", lat: -24.879, lng: 113.659, postcode: "6701", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 798, key_chps: ["Foundation"],
    ...
    heat: { score: 66, level: "High", days_over_35_current: 50, days_over_35_2030: 70, days_over_35_2050: 90, days_over_40_current: 7, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 42, notes: "Remote WA mid-coast extreme heat. 50 days above 35 degrees currently. Significant First Nations population in poor quality housing." },
    ...
    overall_score: 50, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-salisbury", suburb_name: "Salisbury", lga_name: "Salisbury City", sa4_name: "Adelaide — North", state: "SA", lat: -34.759, lng: 138.641, postcode: "5108", social_housing_density: "High", est_social_dwellings: 2800, seifa_score: 812, key_chps: ["Unity Housing", "Housing Choices"],
    ...
    heat: { score: 60, level: "High", days_over_35_current: 22, days_over_35_2030: 30, days_over_35_2050: 39, days_over_40_current: 4, urban_heat_island_factor: 3.2, tree_canopy_cover_pct: 5, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "Adjacent to Elizabeth — shares the same extreme urban heat island. SA Housing Authority's largest social housing estate precinct. Near-zero canopy cover and cooling access in oldest stock." },
    coastal: null, cyclone: null, overall_score: 36, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-murray-bridge", suburb_name: "Murray Bridge", lga_name: "Murray Bridge Rural City", sa4_name: "South Australia — South East", state: "SA", lat: -35.117, lng: 139.267, postcode: "5253", social_housing_density: "High", est_social_dwellings: 1200, seifa_score: 832, key_chps: ["Unity Housing", "Anglicare"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 14, tenant_vulnerability: "High", cooling_access_rate_pct: 45, notes: "Inland SA heat with significant elderly and Indigenous population in social housing." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "sa-mount-gambier", suburb_name: "Mount Gambier", lga_name: "City of Mount Gambier", sa4_name: "South Australia — South East", state: "SA", lat: -37.829, lng: 140.782, postcode: "5290", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 898, key_chps: ["Unity Housing"],
    ...
    heat: { score: 30, level: "Low", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 30, tenant_vulnerability: "Low", cooling_access_rate_pct: 68, notes: "South-eastern SA city with cooler climate and moderate heat risk." },
    coastal: null, cyclone: null, overall_score: 36, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "tas-burnie", suburb_name: "Burnie", lga_name: "Burnie City", sa4_name: "West and North West", state: "TAS", lat: -41.055, lng: 145.905, postcode: "7320", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 878, key_chps: ["Housing Choices"],
    ...
    heat: { score: 25, level: "Low", days_over_35_current: 1, days_over_35_2030: 1, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.8, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 78, notes: "Northwest Tasmania coastal climate — currently cool." },
    ...
    cyclone: null, overall_score: 34, overall_level: "Low", primary_hazard: "Coastal",
  ...
  { id: "tas-queenstown", suburb_name: "Queenstown", lga_name: "West Coast Council", sa4_name: "West and North West", state: "TAS", lat: -42.079, lng: 145.554, postcode: "7467", social_housing_density: "Medium", est_social_dwellings: 600, seifa_score: 792, key_chps: ["Housing Choices"],
    ...
    heat: { score: 28, level: "Low", days_over_35_current: 1, days_over_35_2030: 1, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.5, tree_canopy_cover_pct: 15, tenant_vulnerability: "Low", cooling_access_rate_pct: 85, notes: "Cold mountain climate. Heat is not a significant risk." },
    coastal: null, cyclone: null, overall_score: 40, overall_level: "Low", primary_hazard: "Flood",
  ...
  { id: "nt-tennant-creek", suburb_name: "Tennant Creek", lga_name: "Barkly Regional", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -19.649, lng: 134.193, postcode: "0860", social_housing_density: "High", est_social_dwellings: 1000, seifa_score: 692, key_chps: ["CHL"],
    ...
    heat: { score: 88, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 4, tenant_vulnerability: "Critical", cooling_access_rate_pct: 28, notes: "One of Australia's hottest and most disadvantaged communities. 93 days above 35 degrees currently — near-continuous extreme heat by 2050. SEIFA 692 (most disadvantaged nationally). Town camp housing in critical condition with unreliable power for cooling." },
    coastal: null, cyclone: null, overall_score: 57, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "nt-nhulunbuy", suburb_name: "Nhulunbuy / Yirrkala", lga_name: "East Arnhem", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -12.182, lng: 136.775, postcode: "0880", social_housing_density: "High", est_social_dwellings: 1200, seifa_score: 702, key_chps: ["CHL", "MA Housing"],
    ...
    overall_score: 55, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "act-belconnen", suburb_name: "Belconnen", lga_name: "ACT Government", sa4_name: "Australian Capital Territory", state: "ACT", territory: true, lat: -35.235, lng: 149.063, postcode: "2617", social_housing_density: "Medium", est_social_dwellings: 1800, seifa_score: 998, key_chps: ["CHC"],
    ...
    heat: { score: 31, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 24, tenant_vulnerability: "Low", cooling_access_rate_pct: 65, notes: "Canberra heat increasing under climate projections. Older Belconnen Housing estate (1970s-80s) has poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 37, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "act-woden", suburb_name: "Woden / Weston Creek", lga_name: "ACT Government", sa4_name: "Australian Capital Territory", state: "ACT", territory: true, lat: -35.345, lng: 149.082, postcode: "2611", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 1012, key_chps: ["CHC"],
    ...
    heat: { score: 33, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 28, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 65, notes: "Southern Canberra heat. Some older public housing with poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 39, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "nsw-claymore", suburb_name: "Claymore / Macquarie Fields", lga_name: "Campbelltown City", sa4_name: "Sydney — South West", state: "NSW", lat: -34.026, lng: 150.875, postcode: "2559", social_housing_density: "Very High", est_social_dwellings: 3600, seifa_score: 742, key_chps: ["SGCH", "Uniting"],
    ...
    heat: { score: 55, level: "High", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.8, tree_canopy_cover_pct: 8, tenant_vulnerability: "Critical", cooling_access_rate_pct: 35, notes: "One of Australia's most disadvantaged housing estates. Claymore has SEIFA 742 — deepest disadvantage in SW Sydney. Heat mortality risk is extreme with very low cooling access." },
    coastal: null, cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-villawood", suburb_name: "Villawood / Fairfield", lga_name: "Fairfield City", sa4_name: "Sydney — South West", state: "NSW", lat: -33.877, lng: 150.997, postcode: "2163", social_housing_density: "High", est_social_dwellings: 2800, seifa_score: 792, key_chps: ["SGCH", "Uniting"],
    ...
    heat: { score: 53, level: "Moderate", days_over_35_current: 15, days_over_35_2030: 21, days_over_35_2050: 27, days_over_40_current: 2, urban_heat_island_factor: 2.5, tree_canopy_cover_pct: 10, tenant_vulnerability: "Critical", cooling_access_rate_pct: 40, notes: "Largest CALD social housing population in Australia. Multiple language barriers to heat-health warnings. Refugee communities with high heat vulnerability." },
    coastal: null, cyclone: null, overall_score: 42, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-grafton", suburb_name: "Grafton", lga_name: "Clarence Valley", sa4_name: "Richmond — Tweed", state: "NSW", lat: -29.691, lng: 152.932, postcode: "2460", social_housing_density: "High", est_social_dwellings: 1400, seifa_score: 842, key_chps: ["Home in Place"],
    ...
    heat: { score: 36, level: "Low", days_over_35_current: 10, days_over_35_2030: 14, days_over_35_2050: 18, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Inland Northern Rivers heat, increasing significantly." },
  ...
  { id: "nsw-kempsey", suburb_name: "Kempsey", lga_name: "Kempsey Shire", sa4_name: "Mid North Coast", state: "NSW", lat: -31.083, lng: 152.835, postcode: "2440", social_housing_density: "High", est_social_dwellings: 1200, seifa_score: 818, key_chps: ["Home in Place"],
    ...
    heat: { score: 31, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 26, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 62, notes: "Coastal sub-tropical heat, moderate risk currently." },
    coastal: null, cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "nsw-queanbeyan", suburb_name: "Queanbeyan", lga_name: "Queanbeyan-Palerang", sa4_name: "Capital Region", state: "NSW", lat: -35.354, lng: 149.234, postcode: "2620", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 924, key_chps: ["CHC", "Anglicare"],
    ...
    heat: { score: 32, level: "Low", days_over_35_current: 11, days_over_35_2030: 15, days_over_35_2050: 20, days_over_40_current: 1, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 25, tenant_vulnerability: "Low", cooling_access_rate_pct: 65, notes: "Canberra-adjacent climate with moderate heat." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "nsw-muswellbrook", suburb_name: "Muswellbrook", lga_name: "Muswellbrook Shire", sa4_name: "Hunter Valley exc Newcastle", state: "NSW", lat: -32.267, lng: 150.887, postcode: "2333", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 882, key_chps: ["Hume"],
    ...
    heat: { score: 44, level: "Moderate", days_over_35_current: 14, days_over_35_2030: 20, days_over_35_2050: 25, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 15, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Upper Hunter Valley heat. Coal mining decline compounds socioeconomic disadvantage. Social housing stock is aging with poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-port-macquarie", suburb_name: "Port Macquarie", lga_name: "Port Macquarie-Hastings", sa4_name: "Mid North Coast", state: "NSW", lat: -31.430, lng: 152.909, postcode: "2444", social_housing_density: "Medium", est_social_dwellings: 1400, seifa_score: 938, key_chps: ["Home in Place"],
    ...
    heat: { score: 33, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 30, tenant_vulnerability: "High", cooling_access_rate_pct: 65, notes: "Coastal location moderates heat. Large retiree population with heat vulnerability." },
    ...
    cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Coastal",
  ...
  { id: "qld-caboolture", suburb_name: "Caboolture / Morayfield", lga_name: "Moreton Bay Region", sa4_name: "Moreton Bay — North", state: "QLD", lat: -27.085, lng: 152.951, postcode: "4510", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 872, key_chps: ["CHL", "Centacare"],
    ...
    heat: { score: 38, level: "Low", days_over_35_current: 4, days_over_35_2030: 6, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 58, notes: "Outer SEQ suburb with significant social housing growth." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-eagleby", suburb_name: "Eagleby", lga_name: "Logan City", sa4_name: "Logan — Beaudesert", state: "QLD", lat: -27.707, lng: 153.199, postcode: "4207", social_housing_density: "Very High", est_social_dwellings: 2800, seifa_score: 772, key_chps: ["CHL", "Centacare"],
    ...
    heat: { score: 40, level: "Moderate", days_over_35_current: 4, days_over_35_2030: 6, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 16, tenant_vulnerability: "High", cooling_access_rate_pct: 55, notes: "Outer southern Brisbane heat with high social housing density." },
    coastal: null, cyclone: null, overall_score: 46, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-mareeba", suburb_name: "Mareeba", lga_name: "Mareeba Shire", sa4_name: "Cairns", state: "QLD", lat: -16.994, lng: 145.420, postcode: "4880", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 812, key_chps: ["CHL"],
    ...
    heat: { score: 44, level: "Moderate", days_over_35_current: 3, days_over_35_2030: 5, days_over_35_2050: 6, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 12, tenant_vulnerability: "Critical", cooling_access_rate_pct: 45, notes: "Tablelands heat — inland from Cairns, lacks coastal moderation. Significant First Nations population in social housing with limited cooling." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "qld-emerald", suburb_name: "Emerald", lga_name: "Central Highlands", sa4_name: "Central Queensland", state: "QLD", lat: -23.527, lng: 148.162, postcode: "4720", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 898, key_chps: ["CHL"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 16, days_over_35_2030: 22, days_over_35_2050: 29, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 12, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 55, notes: "Central Queensland inland heat. Mining and agricultural workforce." },
    coastal: null, cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-longreach", suburb_name: "Longreach", lga_name: "Longreach Region", sa4_name: "Queensland — Outback (North)", state: "QLD", lat: -23.443, lng: 144.249, postcode: "4730", social_housing_density: "Medium", est_social_dwellings: 600, seifa_score: 818, key_chps: ["CHL"],
    ...
    heat: { score: 95, level: "Critical", days_over_35_current: 127, days_over_35_2030: 159, days_over_35_2050: 184, days_over_40_current: 23, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 3, tenant_vulnerability: "Critical", cooling_access_rate_pct: 35, notes: "Remote western QLD — 127 days above 35 degrees currently, approaching near-continuous extreme heat by 2050. Very low cooling access. Significant Indigenous population in poor quality housing." },
  ...
  { id: "qld-innisfail", suburb_name: "Innisfail", lga_name: "Cassowary Coast", sa4_name: "Cairns", state: "QLD", lat: -17.526, lng: 146.028, postcode: "4860", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 838, key_chps: ["CHL", "Horizon"],
    ...
    heat: { score: 60, level: "High", days_over_35_current: 3, days_over_35_2030: 5, days_over_35_2050: 6, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 20, tenant_vulnerability: "High", cooling_access_rate_pct: 60, notes: "Tropical heat and humidity. Wet season heat-humidity creates near-dangerous conditions." },
    ...
    overall_score: 55, overall_level: "High", primary_hazard: "Cyclone",
  ...
  { id: "qld-maryborough", suburb_name: "Maryborough", lga_name: "Fraser Coast", sa4_name: "Wide Bay", state: "QLD", lat: -25.538, lng: 152.699, postcode: "4650", social_housing_density: "High", est_social_dwellings: 1600, seifa_score: 858, key_chps: ["CHL"],
    ...
    heat: { score: 37, level: "Low", days_over_35_current: 5, days_over_35_2030: 7, days_over_35_2050: 9, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 20, tenant_vulnerability: "High", cooling_access_rate_pct: 58, notes: "Wide Bay inland heat with significant aging social housing population." },
    coastal: null, cyclone: null, overall_score: 44, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-charters-towers", suburb_name: "Charters Towers", lga_name: "Charters Towers Region", sa4_name: "Townsville", state: "QLD", lat: -20.073, lng: 146.262, postcode: "4820", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 832, key_chps: ["Horizon"],
    ...
    heat: { score: 47, level: "Moderate", days_over_35_current: 4, days_over_35_2030: 5, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "North Queensland outback heat. Significant First Nations population. Historic mining town in decline with ageing social housing stock and very limited cooling access." },
    coastal: null, cyclone: null, overall_score: 36, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-karratha", suburb_name: "Karratha", lga_name: "Karratha City", sa4_name: "WA — Outback (North)", state: "WA", lat: -20.737, lng: 116.846, postcode: "6714", social_housing_density: "High", est_social_dwellings: 1800, seifa_score: 882, key_chps: ["Foundation"],
    ...
    overall_score: 56, overall_level: "High", primary_hazard: "Cyclone",
  ...
  { id: "wa-newman", suburb_name: "Newman", lga_name: "East Pilbara Shire", sa4_name: "WA — Outback (North)", state: "WA", lat: -23.353, lng: 119.734, postcode: "6753", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 812, key_chps: ["Foundation"],
    ...
    heat: { score: 94, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 3, tenant_vulnerability: "Critical", cooling_access_rate_pct: 55, notes: "One of Australia's hottest inhabited towns. 142 days above 35 currently — approaching 6 months of extreme heat by 2050. Mining company housing has better cooling but Indigenous community housing is inadequate." },
  ...
  { id: "wa-derby", suburb_name: "Derby", lga_name: "Derby-West Kimberley", sa4_name: "WA — Outback (North)", state: "WA", lat: -17.311, lng: 123.629, postcode: "6728", social_housing_density: "High", est_social_dwellings: 1000, seifa_score: 728, key_chps: ["Foundation"],
    ...
    heat: { score: 94, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 6, tenant_vulnerability: "Critical", cooling_access_rate_pct: 32, notes: "Remote Kimberley with near-year-round extreme heat. Very high proportion of Indigenous tenants in government housing with very limited cooling access." },
    ...
    overall_score: 66, overall_level: "Critical", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-halls-creek", suburb_name: "Halls Creek", lga_name: "Halls Creek Shire", sa4_name: "WA — Outback (North)", state: "WA", lat: -18.232, lng: 127.666, postcode: "6770", social_housing_density: "High", est_social_dwellings: 800, seifa_score: 688, key_chps: ["Foundation"],
    ...
    overall_score: 65, overall_level: "Critical", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-esperance", suburb_name: "Esperance", lga_name: "Esperance Shire", sa4_name: "WA — Outback (South)", state: "WA", lat: -33.858, lng: 121.891, postcode: "6450", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 924, key_chps: ["Foundation"],
    ...
    heat: { score: 55, level: "High", days_over_35_current: 55, days_over_35_2030: 77, days_over_35_2050: 99, days_over_40_current: 8, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 20, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 62, notes: "Coastal location moderates heat, but inland fire weather is extreme." },
  ...
  { id: "vic-reservoir", suburb_name: "Reservoir / Preston", lga_name: "Darebin City", sa4_name: "Melbourne — North East", state: "VIC", lat: -37.722, lng: 145.001, postcode: "3073", social_housing_density: "High", est_social_dwellings: 2400, seifa_score: 888, key_chps: ["Housing Choices", "Launch"],
    ...
    heat: { score: 48, level: "Moderate", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 2.6, tree_canopy_cover_pct: 10, tenant_vulnerability: "High", cooling_access_rate_pct: 45, notes: "Inner north Melbourne heat island. Significant older social housing stock in poor thermal condition. Large elderly and CALD population." },
    coastal: null, cyclone: null, overall_score: 32, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-werribee", suburb_name: "Werribee / Wyndham", lga_name: "Wyndham City", sa4_name: "Melbourne — West", state: "VIC", lat: -37.899, lng: 144.661, postcode: "3030", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 918, key_chps: ["Housing Choices"],
    ...
    cyclone: null, overall_score: 38, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-springvale", suburb_name: "Springvale / Noble Park", lga_name: "Greater Dandenong", sa4_name: "Melbourne — South East", state: "VIC", lat: -37.949, lng: 145.155, postcode: "3171", social_housing_density: "High", est_social_dwellings: 2200, seifa_score: 812, key_chps: ["Housing Choices"],
    ...
    heat: { score: 50, level: "Moderate", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 10, tenant_vulnerability: "Critical", cooling_access_rate_pct: 40, notes: "SE Melbourne heat island. Australia's largest Vietnamese and Cambodian community — significant language barriers to heat-health warnings. Aging public housing stock." },
    coastal: null, cyclone: null, overall_score: 37, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-sunbury", suburb_name: "Sunbury", lga_name: "Hume City", sa4_name: "Melbourne — North West", state: "VIC", lat: -37.576, lng: 144.728, postcode: "3429", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 946, key_chps: ["Housing Choices"],
    ...
    heat: { score: 39, level: "Low", days_over_35_current: 9, days_over_35_2030: 13, days_over_35_2050: 17, days_over_40_current: 2, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Outer Melbourne satellite town. Heat and bushfire compound risk increasing." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "vic-swan-hill", suburb_name: "Swan Hill", lga_name: "Swan Hill Rural City", sa4_name: "Loddon — Campaspe", state: "VIC", lat: -35.338, lng: 143.552, postcode: "3585", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 892, key_chps: ["Housing Choices"],
    ...
    heat: { score: 47, level: "Moderate", days_over_35_current: 20, days_over_35_2030: 28, days_over_35_2050: 36, days_over_40_current: 2, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 16, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Inland Murray River heat. Significant Indigenous and elderly population. Older social housing stock with poor thermal performance." },
    coastal: null, cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-horsham", suburb_name: "Horsham", lga_name: "Horsham Rural City", sa4_name: "Wimmera", state: "VIC", lat: -36.714, lng: 142.201, postcode: "3400", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 908, key_chps: ["Haven"],
    ...
    heat: { score: 53, level: "Moderate", days_over_35_current: 33, days_over_35_2030: 46, days_over_35_2050: 59, days_over_40_current: 5, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 14, tenant_vulnerability: "High", cooling_access_rate_pct: 50, notes: "Wimmera agricultural region — extreme inland heat. Significant Indigenous population in social housing." },
    coastal: null, cyclone: null, overall_score: 52, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-paralowie", suburb_name: "Paralowie", lga_name: "Playford City", sa4_name: "Adelaide — North", state: "SA", lat: -34.753, lng: 138.629, postcode: "5108", social_housing_density: "Very High", est_social_dwellings: 3200, seifa_score: 742, key_chps: ["Unity Housing", "Housing Choices"],
    ...
    heat: { score: 61, level: "High", days_over_35_current: 22, days_over_35_2030: 30, days_over_35_2050: 39, days_over_40_current: 4, urban_heat_island_factor: 3.3, tree_canopy_cover_pct: 5, tenant_vulnerability: "Critical", cooling_access_rate_pct: 36, notes: "Immediately adjacent to Elizabeth — shares the same extreme urban heat island. Forms part of the Playford social housing mega-precinct with 8,000+ dwellings across Elizabeth, Davoren Park and Paralowie. SEIFA 742 — extreme disadvantage." },
    coastal: null, cyclone: null, overall_score: 34, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-gawler", suburb_name: "Gawler", lga_name: "Gawler Town", sa4_name: "Adelaide — North", state: "SA", lat: -34.601, lng: 138.747, postcode: "5118", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 898, key_chps: ["Unity Housing"],
    ...
    heat: { score: 53, level: "Moderate", days_over_35_current: 22, days_over_35_2030: 30, days_over_35_2050: 39, days_over_40_current: 4, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 10, tenant_vulnerability: "High", cooling_access_rate_pct: 44, notes: "Outer northern Adelaide heat corridor. One of Adelaide's hottest outer suburbs." },
  ...
  { id: "sa-renmark", suburb_name: "Renmark", lga_name: "Renmark Paringa", sa4_name: "South Australia — South East", state: "SA", lat: -34.174, lng: 140.749, postcode: "5341", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 876, key_chps: ["Unity Housing"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 14, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Riverland inland heat. 8 days above 35 currently. Murray River communities have aging social housing stock with poor cooling access." },
    coastal: null, cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-coober-pedy", suburb_name: "Coober Pedy", lga_name: "Coober Pedy", sa4_name: "South Australia — Outback", state: "SA", lat: -29.014, lng: 134.754, postcode: "5723", social_housing_density: "Medium", est_social_dwellings: 600, seifa_score: 766, key_chps: ["Unity Housing"],
    ...
    heat: { score: 84, level: "Critical", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 1, tenant_vulnerability: "Critical", cooling_access_rate_pct: 65, notes: "Coober Pedy is notable for underground housing (dugouts) built specifically to escape the extreme heat. Above-ground housing faces near-lethal conditions in summer. 90 days above 35 currently — approaching 5 months of extreme heat by 2050." },
    coastal: null, cyclone: null, overall_score: 43, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-port-pirie", suburb_name: "Port Pirie", lga_name: "Port Pirie Regional", sa4_name: "South Australia — Outback", state: "SA", lat: -33.186, lng: 138.017, postcode: "5540", social_housing_density: "High", est_social_dwellings: 1800, seifa_score: 838, key_chps: ["Unity Housing"],
    ...
    heat: { score: 84, level: "Critical", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 8, tenant_vulnerability: "Critical", cooling_access_rate_pct: 40, notes: "Industrial port city with severe heat and significant disadvantage. Lead smelter legacy health issues compound heat vulnerability. Many tenants have elevated lead blood levels which increases heat sensitivity." },
    ...
    cyclone: null, overall_score: 52, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-christies-beach", suburb_name: "Christies Beach", lga_name: "Onkaparinga City", sa4_name: "Adelaide — South", state: "SA", lat: -35.137, lng: 138.494, postcode: "5165", social_housing_density: "High", est_social_dwellings: 1600, seifa_score: 868, key_chps: ["Unity Housing"],
    ...
    heat: { score: 51, level: "Moderate", days_over_35_current: 22, days_over_35_2030: 30, days_over_35_2050: 39, days_over_40_current: 4, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 12, tenant_vulnerability: "High", cooling_access_rate_pct: 42, notes: "Southern Adelaide coastal suburb. Large social housing concentration. Heat risk is significant and increasing." },
    ...
    cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "tas-moonah", suburb_name: "Moonah", lga_name: "Glenorchy City", sa4_name: "Hobart", state: "TAS", lat: -42.846, lng: 147.296, postcode: "7009", social_housing_density: "High", est_social_dwellings: 1400, seifa_score: 842, key_chps: ["Housing Choices"],
    ...
    heat: { score: 28, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 22, tenant_vulnerability: "Low", cooling_access_rate_pct: 75, notes: "Hobart urban heat moderate. Cooler Tasmania climate." },
    coastal: null, cyclone: null, overall_score: 38, overall_level: "Low", primary_hazard: "Flood",
  ...
  { id: "tas-kingston", suburb_name: "Kingston / Kingborough", lga_name: "Kingborough Council", sa4_name: "Hobart", state: "TAS", lat: -42.978, lng: 147.305, postcode: "7050", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 988, key_chps: ["Housing Choices"],
    ...
    heat: { score: 26, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 1.0, tree_canopy_cover_pct: 35, tenant_vulnerability: "Low", cooling_access_rate_pct: 78, notes: "Southern Hobart — cooler coastal climate." },
    ...
    cyclone: null, overall_score: 36, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "tas-sorell", suburb_name: "Sorell", lga_name: "Sorell Council", sa4_name: "South East", state: "TAS", lat: -42.778, lng: 147.563, postcode: "7172", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 912, key_chps: ["Housing Choices"],
    ...
    heat: { score: 25, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.8, tree_canopy_cover_pct: 30, tenant_vulnerability: "Low", cooling_access_rate_pct: 80, notes: "Rural SE Tasmania — very low heat risk currently." },
    ...
    cyclone: null, overall_score: 41, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "nt-jabiru", suburb_name: "Jabiru", lga_name: "Kakadu Region", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -12.671, lng: 132.834, postcode: "0886", social_housing_density: "High", est_social_dwellings: 500, seifa_score: 722, key_chps: ["CHL"],
    ...
    overall_score: 64, overall_level: "Critical", primary_hazard: "Extreme Heat",
  ...
  { id: "nt-hermannsburg", suburb_name: "Hermannsburg / Ntaria", lga_name: "MacDonnell Region", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -23.943, lng: 132.773, postcode: "0872", social_housing_density: "Very High", est_social_dwellings: 400, seifa_score: 680, key_chps: ["CHL", "MA Housing"],
    ...
    heat: { score: 88, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 3, tenant_vulnerability: "Critical", cooling_access_rate_pct: 20, notes: "SEIFA 680 — one of the most disadvantaged communities in Australia. Central desert extreme heat with virtually no cooling access. Many homes have unreliable power supply making cooling ineffective even when available." },
    coastal: null, cyclone: null, overall_score: 54, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "nt-alyangula", suburb_name: "Alyangula (Groote Eylandt)", lga_name: "Groote Eylandt", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -13.848, lng: 136.419, postcode: "0885", social_housing_density: "High", est_social_dwellings: 600, seifa_score: 742, key_chps: ["CHL", "MA Housing"],
    ...
    heat: { score: 81, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 18, tenant_vulnerability: "Critical", cooling_access_rate_pct: 38, notes: "Remote Gulf of Carpentaria island. Major Anindilyakwa community. GEMCO manganese mine provides some economic base but housing for the Indigenous community is poor quality." },
  ...
  { id: "act-molonglo", suburb_name: "Molonglo / Wright", lga_name: "ACT Government", sa4_name: "Australian Capital Territory", state: "ACT", territory: true, lat: -35.284, lng: 149.040, postcode: "2611", social_housing_density: "Low", est_social_dwellings: 600, seifa_score: 1055, key_chps: ["CHC"],
    ...
    heat: { score: 29, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 26, tenant_vulnerability: "Low", cooling_access_rate_pct: 72, notes: "Newer suburb with better thermal performance in newer stock." },
    coastal: null, cyclone: null, overall_score: 41, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "nsw-cessnock", suburb_name: "Cessnock", lga_name: "Cessnock City", sa4_name: "Hunter Valley exc Newcastle", state: "NSW", lat: -32.832, lng: 151.356, postcode: "2325", social_housing_density: "High", est_social_dwellings: 1400, seifa_score: 848, key_chps: ["Hume"],
    ...
    heat: { score: 43, level: "Moderate", days_over_35_current: 14, days_over_35_2030: 20, days_over_35_2050: 25, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 50, notes: "Hunter Valley inland heat. Economic decline from coal mining closure compounds disadvantage." },
    coastal: null, cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Bushfire",
  ...
  { id: "nsw-taree", suburb_name: "Taree", lga_name: "Mid-Coast Council", sa4_name: "Mid North Coast", state: "NSW", lat: -31.906, lng: 152.457, postcode: "2430", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 876, key_chps: ["Home in Place"],
    ...
    heat: { score: 31, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 26, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 62, notes: "Coastal location moderates heat." },
    coastal: null, cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "nsw-tweed-heads", suburb_name: "Tweed Heads / Banora Point", lga_name: "Tweed Shire", sa4_name: "Richmond — Tweed", state: "NSW", lat: -28.178, lng: 153.540, postcode: "2485", social_housing_density: "Medium", est_social_dwellings: 1200, seifa_score: 924, key_chps: ["Home in Place"],
    ...
    heat: { score: 36, level: "Low", days_over_35_current: 10, days_over_35_2030: 14, days_over_35_2050: 18, days_over_40_current: 0, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 28, tenant_vulnerability: "High", cooling_access_rate_pct: 65, notes: "Coastal sub-tropical with large retiree population." },
  ...
  { id: "nsw-singleton", suburb_name: "Singleton", lga_name: "Singleton Shire", sa4_name: "Hunter Valley exc Newcastle", state: "NSW", lat: -32.571, lng: 151.169, postcode: "2330", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 918, key_chps: ["Hume"],
    ...
    heat: { score: 40, level: "Moderate", days_over_35_current: 14, days_over_35_2030: 20, days_over_35_2050: 25, days_over_40_current: 1, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 18, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 55, notes: "Upper Hunter Valley heat — significant and increasing." },
    coastal: null, cyclone: null, overall_score: 46, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "nsw-armidale", suburb_name: "Armidale", lga_name: "Armidale Regional", sa4_name: "New England and North West", state: "NSW", lat: -30.512, lng: 151.668, postcode: "2350", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 942, key_chps: ["Hume"],
    ...
    heat: { score: 37, level: "Low", days_over_35_current: 19, days_over_35_2030: 27, days_over_35_2050: 34, days_over_40_current: 1, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 26, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "High-altitude New England city. Cooler currently but heat is increasing significantly under projections." },
    coastal: null, cyclone: null, overall_score: 38, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "qld-woodridge", suburb_name: "Woodridge / Kingston", lga_name: "Logan City", sa4_name: "Logan — Beaudesert", state: "QLD", lat: -27.663, lng: 153.106, postcode: "4114", social_housing_density: "Very High", est_social_dwellings: 3800, seifa_score: 748, key_chps: ["CHL", "Centacare"],
    ...
    heat: { score: 47, level: "Moderate", days_over_35_current: 4, days_over_35_2030: 6, days_over_35_2050: 7, days_over_40_current: 0, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 10, tenant_vulnerability: "Critical", cooling_access_rate_pct: 45, notes: "One of SEQ's most concentrated and disadvantaged social housing precincts. SEIFA 748 — extreme disadvantage. Very high proportion of Pacific Islander and First Nations tenants." },
    coastal: null, cyclone: null, overall_score: 41, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "qld-airlie-beach", suburb_name: "Airlie Beach / Proserpine", lga_name: "Whitsunday Region", sa4_name: "Mackay — Isaac — Whitsunday", state: "QLD", lat: -20.268, lng: 148.717, postcode: "4802", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 882, key_chps: ["CHL", "Horizon"],
    ...
    heat: { score: 60, level: "High", days_over_35_current: 2, days_over_35_2030: 3, days_over_35_2050: 4, days_over_40_current: 0, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 20, tenant_vulnerability: "High", cooling_access_rate_pct: 60, notes: "Tropical North Queensland heat. Tourism economy creates social disparities." },
    ...
    overall_score: 54, overall_level: "High", primary_hazard: "Cyclone",
  ...
  { id: "qld-dalby", suburb_name: "Dalby", lga_name: "Dalby Town", sa4_name: "Darling Downs — Maranoa", state: "QLD", lat: -27.185, lng: 151.265, postcode: "4405", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 876, key_chps: ["CHL"],
    ...
    heat: { score: 46, level: "Moderate", days_over_35_current: 24, days_over_35_2030: 34, days_over_35_2050: 43, days_over_40_current: 3, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 14, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 55, notes: "Darling Downs agricultural inland heat. Significant and increasing." },
    coastal: null, cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "qld-st-george", suburb_name: "St George", lga_name: "Balonne Shire", sa4_name: "Darling Downs — Maranoa", state: "QLD", lat: -28.052, lng: 148.585, postcode: "4487", social_housing_density: "Medium", est_social_dwellings: 600, seifa_score: 848, key_chps: ["CHL"],
    ...
    heat: { score: 52, level: "Moderate", days_over_35_current: 24, days_over_35_2030: 34, days_over_35_2050: 43, days_over_40_current: 3, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 8, tenant_vulnerability: "High", cooling_access_rate_pct: 42, notes: "Southwest Queensland extreme heat. Remote outback conditions." },
    coastal: null, cyclone: null, overall_score: 52, overall_level: "High", primary_hazard: "Flood",
  ...
  { id: "qld-winton", suburb_name: "Winton", lga_name: "Winton Shire", sa4_name: "Queensland — Outback (North)", state: "QLD", lat: -22.396, lng: 143.039, postcode: "4735", social_housing_density: "Medium", est_social_dwellings: 350, seifa_score: 808, key_chps: ["CHL"],
    ...
    heat: { score: 95, level: "Critical", days_over_35_current: 127, days_over_35_2030: 159, days_over_35_2050: 184, days_over_40_current: 23, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 2, tenant_vulnerability: "Critical", cooling_access_rate_pct: 30, notes: "Remote western Queensland outback — 127 days above 35 degrees currently, approaching near-continuous extreme heat by 2050. SEIFA disadvantage with poor quality housing and minimal cooling access." },
    coastal: null, cyclone: null, overall_score: 54, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-mildura", suburb_name: "Mildura", lga_name: "Mildura Rural City", sa4_name: "Loddon — Campaspe", state: "VIC", lat: -34.184, lng: 142.148, postcode: "3500", social_housing_density: "High", est_social_dwellings: 1800, seifa_score: 886, key_chps: ["Housing Choices"],
    ...
    heat: { score: 51, level: "Moderate", days_over_35_current: 20, days_over_35_2030: 28, days_over_35_2050: 36, days_over_40_current: 2, urban_heat_island_factor: 2.0, tree_canopy_cover_pct: 12, tenant_vulnerability: "Critical", cooling_access_rate_pct: 44, notes: "One of Victoria's hottest cities — 20 days above 35 degrees currently. Significant First Nations and seasonal worker populations in social housing with inadequate cooling. Murray Sunset National Park creates fire smoke risk compounding heat." },
    coastal: null, cyclone: null, overall_score: 46, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "vic-sale", suburb_name: "Sale", lga_name: "Wellington Shire", sa4_name: "Gippsland", state: "VIC", lat: -38.102, lng: 147.066, postcode: "3850", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 906, key_chps: ["Haven"],
    ...
    heat: { score: 34, level: "Low", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 24, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Gippsland regional city. Heat is moderate currently but increasing." },
    coastal: null, cyclone: null, overall_score: 47, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "wa-midland", suburb_name: "Midland", lga_name: "Swan City", sa4_name: "Perth — North East", state: "WA", lat: -31.888, lng: 116.000, postcode: "6056", social_housing_density: "High", est_social_dwellings: 2000, seifa_score: 878, key_chps: ["Foundation", "Housing Choices"],
    ...
    heat: { score: 54, level: "Moderate", days_over_35_current: 27, days_over_35_2030: 38, days_over_35_2050: 48, days_over_40_current: 4, urban_heat_island_factor: 2.4, tree_canopy_cover_pct: 10, tenant_vulnerability: "High", cooling_access_rate_pct: 50, notes: "Perth eastern suburbs heat corridor. Significant social housing concentration with older thermal performance." },
    coastal: null, cyclone: null, overall_score: 50, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-meekatharra", suburb_name: "Meekatharra", lga_name: "Meekatharra Shire", sa4_name: "WA — Outback (South)", state: "WA", lat: -26.593, lng: 118.496, postcode: "6642", social_housing_density: "High", est_social_dwellings: 500, seifa_score: 742, key_chps: ["Foundation"],
    ...
    heat: { score: 71, level: "High", days_over_35_current: 55, days_over_35_2030: 77, days_over_35_2050: 99, days_over_40_current: 8, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 2, tenant_vulnerability: "Critical", cooling_access_rate_pct: 28, notes: "Remote central WA outback — 55 days above 35 degrees. Significant Indigenous community in government housing with very limited cooling access. Essentially approaching year-round extreme heat already." },
    coastal: null, cyclone: null, overall_score: 38, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "wa-marble-bar", suburb_name: "Marble Bar", lga_name: "East Pilbara Shire", sa4_name: "WA — Outback (North)", state: "WA", lat: -21.177, lng: 119.734, postcode: "6760", social_housing_density: "Medium", est_social_dwellings: 200, seifa_score: 710, key_chps: ["Foundation"],
    ...
    heat: { score: 96, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.4, tree_canopy_cover_pct: 1, tenant_vulnerability: "Critical", cooling_access_rate_pct: 22, notes: "Marble Bar is officially the world record holder for consecutive days above 37.8 degrees (160 days in 1923-24). Currently 142 days above 35 degrees annually — by 2050 this approaches 8 months of continuous extreme heat. The small Aboriginal community here lives in conditions that will be physiologically dangerous for large parts of the year." },
    coastal: null, cyclone: null, overall_score: 49, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-roxby-downs", suburb_name: "Roxby Downs", lga_name: "Roxby Downs Municipality", sa4_name: "South Australia — Outback", state: "SA", lat: -30.552, lng: 136.875, postcode: "5725", social_housing_density: "Medium", est_social_dwellings: 400, seifa_score: 892, key_chps: ["Unity Housing"],
    ...
    heat: { score: 77, level: "Critical", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 5, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 72, notes: "Remote SA mining town. BHP-operated so housing quality is better than most remote communities. However, extreme heat is a significant and worsening challenge." },
    coastal: null, cyclone: null, overall_score: 39, overall_level: "Low", primary_hazard: "Extreme Heat",
  ...
  { id: "sa-port-lincoln", suburb_name: "Port Lincoln", lga_name: "Port Lincoln City", sa4_name: "South Australia — Outback", state: "SA", lat: -34.726, lng: 135.861, postcode: "5606", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 908, key_chps: ["Unity Housing"],
    ...
    heat: { score: 73, level: "High", days_over_35_current: 90, days_over_35_2030: 112, days_over_35_2050: 130, days_over_40_current: 15, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 18, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 58, notes: "Eyre Peninsula coastal heat. Bushfire smoke events compound heat-health risk." },
    ...
    cyclone: null, overall_score: 52, overall_level: "High", primary_hazard: "Bushfire",
  ...
  { id: "tas-ulverstone", suburb_name: "Ulverstone", lga_name: "Central Coast TAS", sa4_name: "West and North West", state: "TAS", lat: -41.158, lng: 146.171, postcode: "7315", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 912, key_chps: ["Housing Choices"],
    ...
    heat: { score: 25, level: "Low", days_over_35_current: 1, days_over_35_2030: 1, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.8, tree_canopy_cover_pct: 30, tenant_vulnerability: "Low", cooling_access_rate_pct: 78, notes: "Northwest Tasmanian climate. Very low heat risk currently." },
  ...
  { id: "tas-new-town", suburb_name: "New Town", lga_name: "Hobart City", sa4_name: "Hobart", state: "TAS", lat: -42.867, lng: 147.324, postcode: "7008", social_housing_density: "High", est_social_dwellings: 1200, seifa_score: 888, key_chps: ["Housing Choices"],
    ...
    heat: { score: 29, level: "Low", days_over_35_current: 1, days_over_35_2030: 2, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 25, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 72, notes: "Inner Hobart. Low heat risk currently." },
    coastal: null, cyclone: null, overall_score: 33, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "nt-yuendumu", suburb_name: "Yuendumu", lga_name: "Central Desert", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -22.258, lng: 131.781, postcode: "0872", social_housing_density: "Very High", est_social_dwellings: 350, seifa_score: 672, key_chps: ["CHL", "MA Housing"],
    ...
    heat: { score: 89, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 3, tenant_vulnerability: "Critical", cooling_access_rate_pct: 18, notes: "SEIFA 672 — among the most disadvantaged communities in Australia. Remote central desert community with 93 days above 35 degrees and cooling access rate of only 18%. This is a life-threatening situation that will become catastrophic by 2050." },
    coastal: null, cyclone: null, overall_score: 54, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "nt-maningrida", suburb_name: "Maningrida", lga_name: "West Arnhem", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -12.058, lng: 134.233, postcode: "0822", social_housing_density: "Very High", est_social_dwellings: 600, seifa_score: 698, key_chps: ["CHL"],
    ...
    heat: { score: 82, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 18, tenant_vulnerability: "Critical", cooling_access_rate_pct: 32, notes: "Remote Arnhem Land coastal community. Large Kuninjku community with housing stock in critical condition. Near-constant wet season heat-humidity creates dangerous conditions." },
    ...
    overall_score: 62, overall_level: "Critical", primary_hazard: "Extreme Heat",
  ...
  { id: "nsw-forster", suburb_name: "Forster / Tuncurry", lga_name: "Mid-Coast Council", sa4_name: "Mid North Coast", state: "NSW", lat: -32.182, lng: 152.512, postcode: "2428", social_housing_density: "Medium", est_social_dwellings: 900, seifa_score: 932,  key_chps: ["Home in Place"],
    ...
    heat: { score: 33, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 32, tenant_vulnerability: "High", cooling_access_rate_pct: 68, notes: "Coastal climate moderates heat. Large retiree population with heat vulnerability." },
  ...
  { id: "nsw-goulburn", suburb_name: "Goulburn", lga_name: "Goulburn Mulwaree", sa4_name: "Southern Highlands and Shoalhaven", state: "NSW", lat: -34.754, lng: 149.718, postcode: "2580", social_housing_density: "Medium", est_social_dwellings: 1000, seifa_score: 914, key_chps: ["Anglicare"],
    ...
    heat: { score: 34, level: "Low", days_over_35_current: 5, days_over_35_2030: 7, days_over_35_2050: 9, days_over_40_current: 0, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 60, notes: "Southern tablelands city with increasing heat under climate projections." },
    coastal: null, cyclone: null, overall_score: 38, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "qld-roma", suburb_name: "Roma", lga_name: "Maranoa Region", sa4_name: "Darling Downs — Maranoa", state: "QLD", lat: -26.574, lng: 148.789, postcode: "4455", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 868, key_chps: ["CHL"],
    ...
    heat: { score: 51, level: "Moderate", days_over_35_current: 24, days_over_35_2030: 34, days_over_35_2050: 43, days_over_40_current: 3, urban_heat_island_factor: 1.8, tree_canopy_cover_pct: 10, tenant_vulnerability: "High", cooling_access_rate_pct: 48, notes: "Southwest Queensland inland heat. Significant and worsening." },
    coastal: null, cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Flood",
  ...
  { id: "vic-warragul", suburb_name: "Warragul", lga_name: "Baw Baw Shire", sa4_name: "Gippsland", state: "VIC", lat: -38.168, lng: 145.929, postcode: "3820", social_housing_density: "Medium", est_social_dwellings: 800, seifa_score: 934, key_chps: ["Haven"],
    ...
    heat: { score: 30, level: "Low", days_over_35_current: 8, days_over_35_2030: 11, days_over_35_2050: 14, days_over_40_current: 1, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 28, tenant_vulnerability: "Low", cooling_access_rate_pct: 65, notes: "Gippsland hills climate. Heat is moderate but increasing." },
  ...
  { id: "wa-tom-price", suburb_name: "Tom Price", lga_name: "Ashburton Shire", sa4_name: "WA — Outback (North)", state: "WA", lat: -22.694, lng: 117.793, postcode: "6751", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 858, key_chps: ["Foundation"],
    ...
    bushfire: { score: 12, level: "Low", in_bushfire_prone_land: false, bal_zone: "N/A", pct_area_bushfire_prone: 5, notes: "Arid Pilbara, no conventional bushfire risk." },
    heat: { score: 90, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 3, tenant_vulnerability: "High", cooling_access_rate_pct: 68, notes: "Pilbara mining town with extreme heat. 142 days above 35 degrees currently. Mining company (Rio Tinto) housing is better quality than community housing but all face extreme climate conditions." },
    coastal: null, cyclone: null, overall_score: 45, overall_level: "Moderate", primary_hazard: "Extreme Heat",
  ...
  { id: "tas-smithton", suburb_name: "Smithton", lga_name: "Circular Head Council", sa4_name: "West and North West", state: "TAS", lat: -40.843, lng: 145.116, postcode: "7330", social_housing_density: "Medium", est_social_dwellings: 500, seifa_score: 882, key_chps: ["Housing Choices"],
    ...
    heat: { score: 25, level: "Low", days_over_35_current: 1, days_over_35_2030: 1, days_over_35_2050: 2, days_over_40_current: 0, urban_heat_island_factor: 0.7, tree_canopy_cover_pct: 32, tenant_vulnerability: "Low", cooling_access_rate_pct: 80, notes: "Northwest TAS — currently very low heat risk." },
  ...
  { id: "tas-launceston-ravenswood-2", suburb_name: "Ravenswood Heights", lga_name: "Launceston City", sa4_name: "Launceston and North East", state: "TAS", lat: -41.465, lng: 147.150, postcode: "7250", social_housing_density: "High", est_social_dwellings: 1000, seifa_score: 772, key_chps: ["Housing Choices"],
    ...
    heat: { score: 31, level: "Low", days_over_35_current: 3, days_over_35_2030: 4, days_over_35_2050: 5, days_over_40_current: 0, urban_heat_island_factor: 1.2, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 70, notes: "Northern TAS — low heat risk currently but increasing." },
    coastal: null, cyclone: null, overall_score: 40, overall_level: "Low", primary_hazard: "Flood",
  ...
  { id: "nt-borroloola", suburb_name: "Borroloola", lga_name: "McArthur Region", sa4_name: "Northern Territory — Outback", state: "NT", territory: true, lat: -16.080, lng: 136.298, postcode: "0854", social_housing_density: "High", est_social_dwellings: 400, seifa_score: 705, key_chps: ["CHL"],
    ...
    heat: { score: 84, level: "Critical", days_over_35_current: 93, days_over_35_2030: 117, days_over_35_2050: 135, days_over_40_current: 17, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 12, tenant_vulnerability: "Critical", cooling_access_rate_pct: 30, notes: "Remote Gulf of Carpentaria community. Garawa and Yanyuwa people. Housing is overcrowded and inadequate for the climate." },
    ...
    overall_score: 61, overall_level: "High", primary_hazard: "Extreme Heat",
  ...
  { id: "act-fraser", suburb_name: "Fraser / Charnwood", lga_name: "ACT Government", sa4_name: "Australian Capital Territory", state: "ACT", territory: true, lat: -35.208, lng: 149.023, postcode: "2615", social_housing_density: "High", est_social_dwellings: 1400, seifa_score: 945, key_chps: ["CHC"],
    ...
    heat: { score: 34, level: "Low", days_over_35_current: 7, days_over_35_2030: 10, days_over_35_2050: 13, days_over_40_current: 0, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 22, tenant_vulnerability: "Moderate", cooling_access_rate_pct: 65, notes: "Northwest Canberra heat increasing under projections." },
    coastal: null, cyclone: null, overall_score: 37, overall_level: "Low", primary_hazard: "Bushfire",
  ...
  { id: "qld-bowen", suburb_name: "Bowen", lga_name: "Whitsunday Region", sa4_name: "Mackay — Isaac — Whitsunday", state: "QLD", lat: -20.011, lng: 148.246, postcode: "4805", social_housing_density: "Medium", est_social_dwellings: 700, seifa_score: 876, key_chps: ["CHL", "Horizon"],
    ...
    heat: { score: 60, level: "High", days_over_35_current: 2, days_over_35_2030: 3, days_over_35_2050: 4, days_over_40_current: 0, urban_heat_island_factor: 1.6, tree_canopy_cover_pct: 18, tenant_vulnerability: "High", cooling_access_rate_pct: 58, notes: "North Queensland coastal heat. Agricultural and tourism economy." },
    ...
    overall_score: 50, overall_level: "Moderate", primary_hazard: "Cyclone",
  ...
  { id: "wa-wiluna", suburb_name: "Wiluna", lga_name: "Wiluna Shire", sa4_name: "WA — Outback (North)", state: "WA", lat: -26.590, lng: 120.225, postcode: "6646", social_housing_density: "High", est_social_dwellings: 300, seifa_score: 695, key_chps: ["Foundation"],
    ...
    heat: { score: 96, level: "Critical", days_over_35_current: 142, days_over_35_2030: 177, days_over_35_2050: 205, days_over_40_current: 31, urban_heat_island_factor: 1.5, tree_canopy_cover_pct: 1, tenant_vulnerability: "Critical", cooling_access_rate_pct: 20, notes: "SEIFA 695 — extreme disadvantage. Remote desert gold-mining town approaching year-round extreme heat by 2050. Martu community housing in critical condition with virtually no cooling access. Life-threatening conditions." },
    coastal: null, cyclone: null, overall_score: 48, overall_level: "Moderate", primary_hazard: "Extreme Heat",
