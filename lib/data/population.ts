...
export const STATE_PROJECTIONS: Record<string, StateProjection> = {
  NSW: {
    ...
    current_approvals: 35500, required_to_meet_demand: 53000, color: "#3498db",
  },
  VIC: {
    ...
    current_approvals: 45200, required_to_meet_demand: 52000, color: "#e74c3c",
  },
  QLD: {
    ...
    current_approvals: 31000, required_to_meet_demand: 44000, color: "#f39c12",
  },
  WA: {
    ...
    current_approvals: 14200, required_to_meet_demand: 22000, color: "#27ae60",
  },
  SA: {
    ...
    current_approvals: 7200, required_to_meet_demand: 11000, color: "#9b59b6",
  },
}
