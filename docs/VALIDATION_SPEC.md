...
|---|---|---|---|---|---|
| 1 | **$137k per-dwelling funding gap** (Development Viability, marketing) | Rawlinsons Cost Guide 2025 (TDC) · Housing Australia lending guidelines (debt) · Treasury HAFF (grant) · ABS/AIHW (social rents) | TDC − HAFF grant − HA debt (sized by rental income) = gap *before land*. State NSW 2-bed example. | Rawlinsons annual · ABS rents quarterly | TODO |
