...
| **C3b** per-suburb HEAT data (`days_over_35/40`) | Climate Risk | CLIMATE_RISK_SUBURBS.heat | Australia Institute HeatWatch (BOM/CSIRO) | 🔴 **OVERSTATED ~2–8×.** Mount Druitt: 38 days>35°C now vs HeatWatch western-Sydney avg **10.6** (last-decade 15.4; 38 ≈ hot-year 2017); 62 by 2050 vs projection **~30**; **12 days>40°C now vs Penrith actual 1.4**. Looks like hot-year/2090 figures mislabelled as current/2050. Likely **systematic across 152 suburbs**. Heat SCORE (0-100) is separately assigned → 152/13 composite less affected, but **displayed heat figures need a BOM per-station re-base**. Action TBD (patch-WSyd vs full re-base vs label indicative). |
