...
| **C3b** HEAT (30% weight) `days_over_35/40` | Climate Risk | .heat | Australia Institute HeatWatch (BOM/CSIRO) | 🔴 **OVERSTATED ~2–8×.** Mount Druitt: 38 days>35°C now vs HeatWatch W-Sydney avg **10.6** (last-decade 15.4; 38 ≈ hot-year 2017); 62 by 2050 vs projection **~30**; **12 days>40°C now vs Penrith actual 1.4**. Hot-year/2090 figures mislabelled as current/2050. Likely systematic. Heat SCORE separately assigned → composite less affected; **displayed figures need BOM per-station re-base**. |
