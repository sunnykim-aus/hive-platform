...
| **C3** per-suburb climate DATA (flood/heat/etc.) | Climate Risk | CLIMATE_RISK_SUBURBS | BOM/CSIRO/state flood/ICA | 🟡 **partial (2026-07)**: suburbs are REAL + flood facts substantially confirmed (Lismore 14.4m/highest-record ✅; minor: peak was **28 Feb** not "March", Lismore town ~1,400 homes not "4,000+"). **Heat projections look HIGH** — HIVE Mount Druitt 38 days>35°C now/62 by 2050 vs published Sydney baseline ~5–15 days; needs per-station BOM/CSIRO source-trace. → NotebookLM prompts added. |
